...
df = data.frame(
  "Category" = c("A", "A", "B","A", "A","A","B","A","A","B"),
...
conTable
###-------------------------
conTable1 # Tiene información de 4 personas
###-------------------------
conTable # Tiene información de 10 personas
...
#1,2 -> rows, columns
tab3 = xtabs(~Treatment+Improved+Sex , data=Arthritis)
tab3
ftable(tab3)
margin.table(tab3,1)
margin.table(tab3,2)
